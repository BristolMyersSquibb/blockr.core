...
#' Register blocks from a YAML registry file
#'
#' Reads a YAML block registry file (as generated by the `block_registration`
#' roclet) and registers the specified blocks. This is the recommended way for
#' packages to register their blocks from `.onLoad()`.
#'
...
#'
#' @return Invisibly returns a list of `block_registry_entry` objects.
#'
#' @export
